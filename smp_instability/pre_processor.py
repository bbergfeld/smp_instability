...
"""
Instability Modelling for Weak Snowpack Layers
----------------------------------------------
...
Dependencies:
- numpy, pandas, concurrent.futures, logging, pickle
- custom 'weac' package and 'logging_class'

Developed by: Bastian Bergfeld
"""
